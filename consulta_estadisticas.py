...
def menu():
    ...
    test_seleccionl = cantidad_partidos_local(partidos,seleccion)
    test_seleccionv = cantidad_partidos_visitante(partidos,seleccion)
    test_seleccion = test_seleccionl + test_seleccionv

    while test_seleccion == 0:
        seleccion = str.capitalize(input('Escriba correctamente la seleccion\n'))

        test_seleccion = cantidad_partidos_local(partidos,seleccion)
        test_seleccionv = cantidad_partidos_visitante(partidos,seleccion)
        test_seleccion = test_seleccionl + test_seleccionv
        ...
        while True:
            ...
            while opciones_numeros == 1:
                ...
                if opciones_letras == 'D':
                    if True:
                        try:
                            opciones_numeros = int(input('Menu Principal: \n'
                                    '1- Para saber cantidad de partidos jugados \n'
                                    '2- Para saber cantidad de partidos ganados \n'
                                    '3- Para saber cantidad de partidos perdidos \n'
                                    '4- Para saber cantidad de partidos empatados \n'
                                    '5- Para saber cantidad de goles que marco \n'
            ...
            while opciones_numeros == 8:
                ...
                test_seleccion_contral = cantidad_partidos_local(partidos,seleccion_contraria)
                test_seleccion_contrav = cantidad_partidos_visitante(partidos,seleccion_contraria)
                test_seleccion_contra = test_seleccion_contral + test_seleccion_contrav

                while test_seleccion_contra == 0:
                    seleccion_contraria = str.capitalize(input('Escriba correctamente la seleccion\n'))
